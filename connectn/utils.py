...
TOURNAMENT_PROCESS_LOG: Path = ROOT_DATA_DIR / "tournament.log"
SERVER_PROCESS_DATA_DIR: Path = ROOT_DATA_DIR / "server_process"
KEY_SALT_FILE: Path = SERVER_PROCESS_DATA_DIR / "keys_salts"
TOURNAMENT_PROCESS_DATA_DIR: Path = ROOT_DATA_DIR / "tournament_process"
TEMP_DIR: Path = TOURNAMENT_PROCESS_DATA_DIR / "tmp"
MOVE_TIME_MAX = 10.0
